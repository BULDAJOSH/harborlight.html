...
<body>
    ...
    <nav role="navigation">
        <ul>
            ...
            <li><a href="#events">Join Our Events</a></li>
       ...
       <section id="about">
        ...
        <section id="events" itemscope itemtype="http://schema.org/Event">
            ...
            <p itemprop="description">
                ...
                Date:
                <time itemprop="startDate" datetime="2050-07-15">
                    July 15, 2050
                </time>
            </p>
        </section>
    ...
    <footer id="contact">
        <h2>Contact Us</h2>
        <p>Email us at:
            <a href="mailto:info@harborlight.com">info@harborlight.com</a>
        </p>
